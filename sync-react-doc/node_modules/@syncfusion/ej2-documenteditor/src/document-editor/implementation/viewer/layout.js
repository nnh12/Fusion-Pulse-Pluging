...
var Layout = /** @class */ (function () {
    ...
    Layout.prototype.layoutItems = function (sections, isReLayout) {
        ...
        for (var i = 0; i < sections.length; i++) {
            ...
            if (i === 0 || isNullOrUndefined(section.sectionFormat.breakCode) || section.sectionFormat.breakCode === 'NewPage' || height !== section.sectionFormat.pageHeight || width !== section.sectionFormat.pageWidth || (section.sectionFormat.columns.length > 1 || (i - 1 >= 0 && sections[i - 1].sectionFormat.columns.length > 1)) || (!isNullOrUndefined(lastpage.bodyWidgets[lastpage.bodyWidgets.length - 1].lastChild) && lastpage.bodyWidgets[lastpage.bodyWidgets.length - 1].lastChild.isEndsWithPageBreak)) {
