    ...
    function FontDialog(documentHelper) {
        ...
        this.onInsertFontFormat = function () {
            ...
            if (!isNullOrUndefined(_this.fontFamily)) {
                ...
                format.fontFamilyAscii = _this.fontFamily;
                format.fontFamilyFarEast = _this.fontFamily;
                format.fontFamilyNonFarEast = _this.fontFamily;
                format.fontFamilyBidi = _this.fontFamily;
            }
