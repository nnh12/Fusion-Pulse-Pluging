...
var Editor = /** @class */ (function () {
    ...
    Editor.prototype.insertImageInternal = function (imageString, isUiInteracted, width, height) {
        var _this = this;
        var formField = this.selection.getCurrentFormField();
        var isFormFillProtectedMode = this.documentHelper.protectionType === 'FormFieldsOnly' && !isNullOrUndefined(formField) && formField.formFieldData instanceof TextFormField;
